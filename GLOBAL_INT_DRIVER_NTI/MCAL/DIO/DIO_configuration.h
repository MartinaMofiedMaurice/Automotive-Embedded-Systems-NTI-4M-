...
/******** Date        : 20/10/2023            *********/
/******** version     : V1.0                 *********/
/******** Description : DIO_Configurations  *********/
/***************************************************/
...
#define PORTD_PIN2_DIRECTION PIN_INPUT
#define PORTD_PIN3_DIRECTION PIN_INPUT
#define PORTD_PIN4_DIRECTION PIN_OUTPUT
#define PORTD_PIN5_DIRECTION PIN_INPUT
#define PORTD_PIN6_DIRECTION PIN_INPUT
#define PORTD_PIN7_DIRECTION PIN_INPUT

//Value:
//     OUTPUT: PIN_LOW/PIN_HIGH
//     INPUT: PIN_PULLUP/PINFLOATING(0)
...
#define PORTD_PIN5_VALUE PIN_PULLUP
#define PORTD_PIN6_VALUE PIN_PULLUP
#define PORTD_PIN7_VALUE PIN_PULLUP
